...
<asp:Content ID="cIntroImage" ContentPlaceHolderID="cphIntroImage" runat="server">
    ...
    <div class="Regis">
        <div class="title">
            <h1 style="color: #52607A">Register</h1>
            <br />
            <hr />
        ...
        <div class=" input">
            ...
            <asp:TextBox ID="FirstName" class="auto-style6" runat="server" placeholder="First Name" ValidationGroup="register"></asp:TextBox><br />
            <br />
            ...
            <asp:TextBox ID="LastName" class="auto-style6" runat="server" placeholder="Last Name" ValidationGroup="register"></asp:TextBox><br />
            <br />
            ...
            <asp:TextBox ID="Phone" class="auto-style6" runat="server" placeholder="Phone Number" ValidationGroup="register"></asp:TextBox><br />
            <br />
            ...
            <asp:TextBox ID="City" class="auto-style6" runat="server" placeholder="City" ValidationGroup="register"></asp:TextBox><br />
            <br />
            ...
            <asp:TextBox ID="UserName" class="auto-style6" runat="server" placeholder="UserName" ValidationGroup="register"></asp:TextBox><br />
            <br />
            ...
            <asp:Button ID="Button2" class="btn btn-secondary btn-lg btn-block" runat="server" Text="Register" OnClick="Button2_Click1" BackColor="#4E667E" ValidationGroup="register" />
        </div>
    </div>
    <br />
    <br />
